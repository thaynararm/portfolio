...
function TextCurriculum() {
    return (
        <div className="texto-about">
            ...
            <div className='curriculum-schooling'>
                <div>
                    <p className='curriculum-title'>Pós-Graduação MBA em Andamento - Engenharia de Software</p>
                    <p className='curriculum-subtitle'>Universidade de São Paulo (USP)</p>
                    <p className='curriculum-text'>Início: 05/2024</p>
                    <p className='curriculum-text'>Provável Conclusão: 12/2025</p>
                </div>
                <div>
                    <p className='curriculum-title'>Graduação em Andamento - Análise e Desenvolvimento de Sistemas</p>
                    <p className='curriculum-subtitle'>Universidade Católica de Brasília (UCB)</p>
                    <p className='curriculum-text'>Início: 01/2023</p>
                    <p className='curriculum-text'>Provável Conclusão: 12/2024</p>
                </div>
                <div>
                    <p className='curriculum-title'>Graduação Completa - Matemática</p>
                    <p className='curriculum-subtitle'>Universidade de Brasília (UnB)</p>
                    <p className='curriculum-text'>Início: 08/2018</p>
                    <p className='curriculum-text'>Conclusão: 08/2022</p>
                </div>
            </div>
